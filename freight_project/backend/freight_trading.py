...
class FreightSim:
    def __init__(self, csv_path="uscities.csv", num_trucks=50, min_pop=50000, enable_finance=False):
        ...
        self.load_counter = 1
        self.loads = pd.DataFrame(columns=[
            'load_id', 'origin_idx', 'dest_idx', 'weight', 'assigned_truck', 'rate_per_ton'
        ])
    ...
    def create_random_load(self):
        ...
        # Assign a random rate per ton to simulate market price ($100–500 per ton)
